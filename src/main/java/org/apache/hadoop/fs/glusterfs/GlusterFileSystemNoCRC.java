...
public class GlusterFileSystemNoCRC extends FilterFileSystem{
    
    protected static final Logger log = LoggerFactory.getLogger(GlusterFileSystemNoCRC.class);
    FileSystem rfs;
    String swapScheme;
    ...
    public GlusterFileSystemNoCRC(){
        this(new GlusterVolume());
        log.info("initializing gluster NO CRC FOR YOU");
    }
    
      public GlusterFileSystemNoCRC(FileSystem rawLocalFileSystem) {
